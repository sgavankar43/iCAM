...
public class DataBaseFinalFmcg extends SQLiteOpenHelper {

    private static final String DATABASE_NAME = "DataBaseFinalFmcgDB";
    private static final int DATABASE_VERSION = 1;
    private static final String TABLE_PRODUCTS = "final_fmcg_products";
    ...
    public DataBaseFinalFmcg(Context context) {
    ...
    private void updateCocaColaPrice(SQLiteDatabase db) {
        ...
        values.put(KEY_QUANTITY, "300 ml");
